...
related_posts:
  _
title: "[Survey Paper] Self-Supervised Learning for Time Series Analysis: Taxonomy, Progress, and Prospects (arXiv 2023)"
original_paper: >
...
- **Augmentation contrast**
  ...
  - variants : [TS2Vec](https://arxiv.org/pdf/2106.10466.pdf) (week augmentation e.g. jitter-and-scale), [CoST](https://arxiv.org/pdf/2202.01575.pdf), [TF-C](https://arxiv.org/pdf/2206.08496.pdf) (frequency domain), [DCdetector](https://arxiv.org/pdf/2306.10347.pdf), [TimeCLR](https://doi.org/10.1016/j.knosys.2022.108606)
- **Prototype contrast**
